...
import SpiffCenterNew from './pages/SpiffCenterNew';
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="flex space-x-4">
              ...
              {user.role === 'partner' ? (
                <Link to="/partner-portal" className="text-slate-700 hover:text-slate-900 px-3 py-2 rounded-md text-sm font-medium" data-testid="nav-partner-portal">
                  My Portal
                </Link>
              ) : (
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/partner-register" element={<PartnerAuth />} />
        <Route
          path="/dashboard"
          element={
            <ProtectedRoute>
